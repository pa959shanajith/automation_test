...
router.get('/', function(req, res, next) {
	...
	if(!req.session.uniqueID) {req.session.destroy(); res.send("/");}
	else {
				...
				data.forEach(function(e,i){
					...
					if(e.type=='modules'){
						...
						if(e.pid_c!='null' && e.pid_c!=undefined){
							qList.push({"statement":"MERGE(n:TESTCASES{screenID:'"+idDict[e.pid]+"',testScenarioID:'"+lts+"',testCaseName:'"+e.name+"',testCaseID:'"+e.id+"',createdBy:'null',createdOn:'null',uid:'"+uidx+"',testCaseID_c:'"+e.id_c+"'}) SET n.screenID_c='"+e.pid_c+"',n.x='"+e.x+"',n.y='"+e.y+"'"});
						}else{
							qList.push({"statement":"MERGE(n:TESTCASES{screenID:'"+idDict[e.pid]+"',testScenarioID:'"+lts+"',testCaseName:'"+e.name+"',testCaseID:'"+e.id+"',createdBy:'null',createdOn:'null',uid:'"+uidx+"',testCaseID_c:'"+e.id_c+"'}) SET n.x='"+e.x+"',n.y='"+e.y+"'"});
						}
