...
function taskRedirectionInner(testsuitedetails,scenarioflag,assignedtestscenarioids,subtasktype,screenid,screenname,projectid,taskname,testcaseid,testcasename,apptype,scenarioid,subtaskid,versionnumber,status,batchTaskIDs,releaseid,cycleid){
	var taskObj = {};
	if(status=='assigned'){
		status='inprogress';
	}
