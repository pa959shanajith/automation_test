...
! function(a, b, c) {
    ...
    d.prototype = {
        ...
        decrementMinute: function(a) {
        	...
        	hours = hours % 12;
        	hours = hours ? hours : 12;
        	if((this.$element.parent("span").siblings().children("input.fc-datePicker").val() === ("0" + new Date().getDate()).slice(-2) +"-"+ ("0" + (new Date().getMonth()+1)).slice(-2) +"-"+ new Date().getFullYear()) && this.hour <= hours && this.minute <= new Date().getMinutes()){
        		return false;
        	}
        	else{
                var b;
