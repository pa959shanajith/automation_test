    ...
    d.prototype = {
        ...
        decrementHour: function() {
            ...
            if (this.showMeridian){
                ...
                if (1 === getHr){
                	if((this.$element.parent("span").siblings().children("input.fc-datePicker").val() === ("0" + new Date().getDate()).slice(-2) +"-"+ ("0" + (new Date().getMonth()+1)).slice(-2) +"-"+ new Date().getFullYear()) && getHr <= hours){
                		return false;
                	}
                	else this.hour = 12;                	
                }
