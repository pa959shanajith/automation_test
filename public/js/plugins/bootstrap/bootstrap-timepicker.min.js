    ...
    d.prototype = {
        ...
        decrementHour: function() {
            ...
            if (this.showMeridian){
                ...
                if (1 === getHr){
                	if((new Date(sltDate[2],(sltDate[1]-1),sltDate[0]).toLocaleString() === curdate.toLocaleString()) && getHr <= new Date().getHours()){
                		return false;
                	}
                	else this.hour--;                	
                }
        ...
        decrementMinute: function(a) {
            ...
            //if(getHr > 12){ getHr = (getHr - 12); flg = true; } else { getHr = this.hour;}
            //getHr > 12? getHr = (getHr - 12) : getHr = this.hour;
        	if((this.$element.parent("span").siblings().children("input.fc-datePicker").val() === ("0" + new Date().getDate()).slice(-2) +"-"+ ("0" + (new Date().getMonth()+1)).slice(-2) +"-"+ new Date().getFullYear()) && getHr <= new Date().getHours() && this.minute <= new Date().getMinutes() ){
        		return false;
        	}
        	else{
                var b;
