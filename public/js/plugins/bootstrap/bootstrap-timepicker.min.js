    ...
    d.prototype = {
        ...
        decrementHour: function() {
            ...
            if (this.showMeridian){
                ...
                if (1 === getHr){
                	if((new Date(sltDate[2],(sltDate[1]-1),sltDate[0]).toLocaleString() === curdate.toLocaleString()) && getHr <= hours && flg != true){
                		return false;
                	}
                	else this.hour--;                	
                }
        ...
        decrementMinute: function(a) {
        	...
        	if((this.$element.parent("span").siblings().children("input.fc-datePicker").val() === ("0" + new Date().getDate()).slice(-2) +"-"+ ("0" + (new Date().getMonth()+1)).slice(-2) +"-"+ new Date().getFullYear()) && getHr <= hours && this.minute <= new Date().getMinutes() && flg != true){
        		return false;
        	}
        	else{
                var b;
