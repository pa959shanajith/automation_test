...
e||1===e.length&&160===e.charCodeAt(0))e="";var x=a.jgrid.createEl.call(c,m[f].edittype,t,e,!0,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));a(x).addClass("editable form-control");l?a("span:first",this).append(x):a(this).append(x);a.jgrid.bindEv.call(c,x,t);"select"===m[f].edittype&&void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie&&a(x).width(a(x).width());g++}}),0<g&&(k.id=b,c.p.savedRow.push(k),a(l).attr("editable","1"),p.focusField&&("number"===
