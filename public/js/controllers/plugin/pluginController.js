		...
		*/
		...
		$(".panel-additional-details").click(function(e){
			...
			if($scope.taskJson[clickedtask].taskDetails[0].taskType == 'Design')
				var adddetailhtml = '<div class="panel panel-default description-container" description-id="'+clickedtask+'"><li class="description-item">Description: '+tdes+'</li><li class="description-item">Release: '+$scope.filterDat.idnamemaprel[$scope.taskJson[clickedtask].releaseid]+'</li><li class="description-item">Cycle: '+$scope.filterDat.idnamemapcyc[$scope.taskJson[clickedtask].cycleid]+'</li><li class="description-item">Apptype: '+$scope.taskJson[0].appType+'</li></div>';
			else
				var adddetailhtml = '<div class="panel panel-default description-container" description-id="'+clickedtask+'"><li class="description-item">Description: '+tdes+'</li><li class="description-item">Release: '+$scope.filterDat.idnamemaprel[$scope.taskJson[clickedtask].testSuiteDetails[0].releaseid]+'</li><li class="description-item">Cycle: '+$scope.filterDat.idnamemapcyc[$scope.taskJson[clickedtask].testSuiteDetails[0].cycleid]+'</li><li class="description-item">Apptype: '+$scope.taskJson[0].appType+'</li></div>';
