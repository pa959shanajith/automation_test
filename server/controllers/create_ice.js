		...
		projectsUnderDomain: function (callback) {
			...
			testsuiteid_exists({
				...
				if (!suiteflag) {
					...
					//Modules History
					inserInSuiteHistory = "' projectid=" + projectid + ",modulename=" + testsuiteName + ",moduleid=" + suiteID + ",versionnumber=" + versionnumber + ",createdby=" + username + ",createdon=" + new Date().getTime().toString() + ",createdthrough=null,deleted=null,modifiedby=null,modifiedbyrole=null,modifiedon=" + new Date().getTime() + ",skucodemodule=null,tags=null,testscenarioids=null '";
					date = new Date().getTime();
					inserInSuiteQuery = "INSERT INTO modules (projectid,moduleid,modulename,versionnumber,history) VALUES (" + projectid + "," + suiteID + ",'" + testsuiteName + "'," + versionnumber + ",{" + date + ":" + inserInSuiteHistory + "})";
						...
						async.forEachSeries(scenario, function (iterator, callback2) {
							...
							testscenariosid_exists({
								...
								if (!scenarioflag) {
									...
									//Scenarios History
									inserInScenarioHistory = "' projectid=" + projectid + ",testscenarioname=" + scenarioName + ",testscenarioid=" + scenarioId + ",versionnumber=" + versionnumber + ",createdby=" + username + ",createdon=" + new Date().getTime().toString() + ",modifiedby=null,modifiedbyrole=null,modifiedon=" + new Date().getTime() + ",skucodetestscenario=null,tags=null,testcaseids=[] '";
									date = new Date().getTime();
											...
											testscreen_exists({
												...
												var screen_query = ''
													if (!screenflag) {
														...
														//Screens History
														inserInScreenHistory = "'projectid=" + projectid + ",screenname=" + scenarioName + ",screenid=" + screenId + ",versionnumber=" + versionnumber + ",createdby=" + username + ",createdon=" + new Date().getTime().toString() + ",createdthrough=null,deleted=null,modifiedby=" + new Date().getTime() + ",modifiedon=null,skucodescreen=null,tags=[] '";
														date = new Date().getTime();
														inserInScreenQuery = "INSERT INTO screens(projectid,screenid,screenname,versionnumber,history) VALUES (" + projectid + "," + screenId + ",'" + scenarioName + "'," + versionnumber + ",{" + date + ":" + inserInScreenHistory + "})";
													} else {
														...
														async.forEachSeries(testcase, function (testcaseitr, callback4) {
															...
															testcase_exists({
																...
																if (!testcaseflag) {
																	...
																	//Testcases History
																	inserInTestcaseHistory = "' screenid=" + screenId + ",testcasename=" + testcaseName + ",testcaseid=" + testcaseID + ",versionnumber=" + versionnumber + ",createdby=" + username + ",createdon=" + new Date().getTime().toString() + ",createdthrough=null,deleted=null,modifiedby=" + new Date().getTime() + ",modifiedon=null,skucodetestcase=null,tags=null,testcasesteps='' '";
																	date = new Date().getTime();
																	inserInTestcaseQuery = "INSERT INTO testcases(screenid,testcasename,testcaseid,versionnumber,history) VALUES (" + screenId + ",'" + testcaseName + "'," + testcaseID + "," + versionnumber + ",{" + date + ":" + inserInTestcaseHistory + "})";
																} else {
