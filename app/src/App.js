...
import ElementRepository from './pages/landing/components/ElementRepository';
  ...
  return (
    ...
    <GeniusSapDialog/>
      <Routes>
        ...
        <Route path="/elementRepository" element={<ElementRepository/>}/>
...
const TabCheck = (setBlockui) => {
  const storage_Handler = (e) => {
    if (window.location.pathname.includes('/executionReport') || window.location.pathname.includes('/reports') || window.location.pathname.includes('/accessibilityReport') || window.location.pathname.includes('/devOpsReport') || window.location.pathname.includes('/viewReports') || window.location.pathname.includes('/profile') || window.location.pathname.includes('/dashboard')) return false;
