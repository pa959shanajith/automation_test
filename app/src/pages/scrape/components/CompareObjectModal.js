...
const CompareObjectModal = props => {
    ...
    const webIcons = [
        ...
        {'src': 'static/imgs/ic-reports-edge-chromium.svg', 'title': 'Launch Microsoft Edge', 'action': ()=>props.startScrape('chromium', 'compare')}
    ];
        ...
        <div className="ss__compareObj">
            <ModalContainer 
                ...
                content={<div data-test="ssCompareObjectContent" className="ss__compareObj_content">
                    <span>Select one of the browsers below to Analyze Screen</span>
