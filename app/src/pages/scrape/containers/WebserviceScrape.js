        ...
        <ScreenWrapper
            ...
            webserviceContent = {<div className="ws__mainContainer mainContainerAd">
                <div className="ws__row">
                    ...
                    <p className={'webservice_btn'}  onClick={() => startScrape()} ><img className='webservice_img' src='static/imgs/ic-webservice.png'/><span id='Websevice_name'>WebService</span></p>
