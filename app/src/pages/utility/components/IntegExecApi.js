...
const IntegExecApi = props => {
    ...
    return (<>
        ...
        <input className={classes["r-api__input"] + " " + (error.url === true ? classes["r-api__inputError"] : "")} placeholder="Enter URL" value={url} onChange={(e) => { setUrl(e.target.value) }} />
        <span className={classes["r-api__inputLabel"]} >Username<span className={classes["r-api__mandate"]}>*</span></span>
        <input className={classes["r-api__input"] + " " + (error.username === true ? classes["r-api__inputError"] : "")} placeholder="Enter Username" value={username} onChange={(e) => { setUsername(e.target.value) }} />
