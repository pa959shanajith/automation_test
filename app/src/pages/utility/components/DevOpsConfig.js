 ...
 const [position, setPosition] = useState('center');
    ...
    return (<>
        ...
        <button data-test="submit-button-test" className='submit-button-test_update' disabled={!text} onClick={() => handleConfigSave(props.currentIntegration.name, false)} >{props.currentIntegration.name == '' ? 'Save' : 'Update'}</button>
            ...
            {(props.currentIntegration.licenseType === false && !props.currentIntegration.disable)?<img src="static/imgs/Execute_now.png" onClick={()=>{handleConfigSave(props.currentIntegration.name, true)}} className='execution-button' title="Execute Now" alt='Execute Now'/>:""}
