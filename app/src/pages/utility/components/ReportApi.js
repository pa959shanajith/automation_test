...
const ReportApi = props => {
    ...
    return (<>
        ...
        <input data-test="exec-id-test" className={classes["r-api__input"] + " " + (error.executionId === true ? classes["r-api__inputError"] : "")} placeholder="Enter Execution ID" value={executionID} onChange={(e)=>{setExecutionID(e.target.value)}} />
