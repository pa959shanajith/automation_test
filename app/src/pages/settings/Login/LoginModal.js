...
import {manageJiraDetails, manageZephyrDetails, manageAzureDetails, getDetails_Azure, getDetails_JIRA, getDetails_ZEPHYR, getDetails_CloudALM} from "../api"
import AvoConfirmDialog from "../../../globalComponents/AvoConfirmDialog";
import { InputSwitch } from "primereact/inputswitch";
import { Accordion, AccordionTab } from 'primereact/accordion';


const LoginModal = ({ isSpin, showCard2, handleIntegration, setShowLoginCard, setAuthType, authType, setTestCaseData }) => {
    const toast = useRef();
    // list of selectors
