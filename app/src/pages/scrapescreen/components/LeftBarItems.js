    ...
    const CreateOptions = (props) => {
        ...
        var _CT =[
          ...
          return (
              ...
              {/* {(apptype==="Webservice")? <div className="leftbar-container">
                <div className="leftbar-top">
                    <ul>
                        <li><span><i className='scrapeOnTxt'>Scrape On</i></span></li>
          ...
          {/* <li><i href="#/Admin" id='userTab' title="Manage Users" onClick={()=>{props.setShowEditUser(false);props.setMiddleScreen("createUser");}} className="selectBrowser" data-name="3">
                      <span><span className='fa fa-user'></span></span>User</i></li> */}
