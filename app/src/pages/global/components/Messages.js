...
const Messages={
    ...
    SCRAPE:{
        ...
        ERR_UNMAPPED_OBJ: {"CONTENT":"Failed to compare objects - Unmapped object(s) found.", "VARIANT": VARIANT.ERROR},
        ERR_COMPARE_OBJ: {"CONTENT":"Failed to compare objects.", "VARIANT": VARIANT.ERROR},
        ERR_SCRAPE: {"CONTENT":"Error while performing Scrape.", "VARIANT": VARIANT.ERROR},
        ERR_UPDATE_OBJ: {"CONTENT":"Failed to update objects.", "VARIANT": VARIANT.ERROR},
        ...
        ERR_NO_OBJ_SCRAPE: {"CONTENT":"The screen has no objects to export, please check.", "VARIANT": VARIANT.ERROR},
        ERR_JSON_IMPORT: {"CONTENT":"Incorrect JSON imported. Please check the contents.", "VARIANT": VARIANT.ERROR},
        ERR_EXCEL_IMPORT: {"CONTENT":"Incorrect Excel imported. Please check the contents.", "VARIANT": VARIANT.ERROR},
        ERR_NO_MATCH_APPTYPE: {"CONTENT":"Project application type and Imported JSON application type doesn't match, please check.", "VARIANT": VARIANT.ERROR},
        ERR_NO_OBJ_IMPORT: {"CONTENT":"The file has no objects to import, please check.", "VARIANT": VARIANT.ERROR},
        ERR_SCREEN_IMPORT: {"CONTENT":"Failed to import Screen JSON.", "VARIANT": VARIANT.ERROR},
        ERR_FILE_FORMAT: {"CONTENT":"Please Check the file format you have uploaded.", "VARIANT": VARIANT.ERROR},
        ERR_DUPLICATE_OBJ: {"CONTENT":"Duplicate Object Names Found.", "VARIANT": VARIANT.ERROR},
    ...
    SCHEDULE:{
        ...
        ERR_DEPENDENT_TASK: {"CONTENT":"All the dependent tasks (design, scrape) needs to be approved before execution.", "VARIANT": VARIANT.ERROR},
