    ...
    return (
        <div className="task-section">
            <div className="task-header">
                ...
                <span className="task-ic-container" onClick={()=>setShowSearch(!showSearch)}><img className="search-ic" src="static/imgs/ic-search-icon.png"/></span>
                <span className="task-ic-container"><img className="filter-ic" src="static/imgs/ic-filter-task.png"/></span>
            </div>
