...
const testCaseIds=currentScnToDelete[0].children.map((screen,idx)=>{
  ...
  return (
    <div className="plugin-bg-container">
      ...
      onHide={() =>{visibleScenario? setVisibleScenario(false):setVisibleReset(false)}} message={visibleScenario?`Recording this scenarios with Avo Genius will override the current scenario. Make sure the screens of this scenario are not reused in any other scenario.Do you still wish to proceed?`:"All the entered data will be cleared."}
