		...
		<ActionBar>
			<div id="left-top-section" className='left-top-section-div'>
				<ul>
					...
					<li><i id='emailGroupTab' title="Manage Email Group Setup" onClick={()=>{props.setMiddleScreen("emailGroupTab");resetScreen("emailGroupTab")}} className="selectBrowser" >
						<span><span className={'fa fa-bell'+ ((props.middleScreen==="emailGroupTab") ? " selected-icon" : "")}  ></span></span>Email Group Setup</i></li>
