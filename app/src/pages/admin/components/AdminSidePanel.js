        ...
        <div className="admin_nav card flex flex-column ">
            ...
            <div className='flex flex-column pl-2 pr-1 m-1 sidepanel_admin'>
                <ul>
                    ...
                    <li onClick={() => { setHeader('Project'); setScreen('project'); }} className={currentScreen === "Project" ? "active_tab" : "not_active_tab"}>
                    ...
                    <li onClick={() => { setHeader('Locked_TestSuites'); setScreen('Locked_TestSuites'); }} className={currentScreen === "Locked_TestSuites" ? "active_tab" : "not_active_tab"}>
