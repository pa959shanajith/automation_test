        ...
        <Fragment>
            ...
            <div className='adminControl-ldap-dm'><div>
                ...
                <select value={props.fieldmap.uname} onChange={(event)=>{props.setFieldmap({uname: event.target.value, fname: props.fieldmap.fname, lname: props.fieldmap.lname, email: props.fieldmap.email})}} id="ldapFMapUname" className={'adminSelect-ldap-dm form-control-ldap-dm'+ (props.ldapFMapUnameErrBor ? " selectErrorBorder" : "")}   >
                    {props.ldapEdit && props.fieldMapOpts.indexOf(props.fieldmap.uname)==-1 ?<option disabled={props.fieldmap.uname==="None"?true:false} value={props.fieldmap.uname} selected >{props.fieldmap.uname}</option>:null}
                    {props.fieldMapOpts.map((field,index)=>(
                        <option disabled={field==="None"?true:false} key={index} value={field} selected={field===props.fieldmap.uname}>{field}</option>
                    ))}
                </select>
            </div></div>
            <div className='adminControl-ldap-dm'><div>
                ...
                {props.ldapEdit && props.fieldMapOpts.indexOf(props.fieldmap.fname)==-1 ?<option disabled={props.fieldmap.fname==="None"?true:false} value={props.fieldmap.fname} selected >{props.fieldmap.fname}</option>:null}
                {props.fieldMapOpts.map((field,index)=>(
                        <option disabled={field==="None"?true:false} key={index} value={field} selected={field===props.fieldmap.fname}>{field}</option>
                    ))}
                </select>
            </div></div>
            <div className='adminControl-ldap-dm'><div>
                ...
                <select value={props.fieldmap.lname} onChange={(event)=>{props.setFieldmap({uname: props.fieldmap.uname, fname: props.fieldmap.fname, lname: event.target.value, email: props.fieldmap.email})}}  id="ldapFMapLname" className={'adminSelect-ldap-dm form-control-ldap-dm'+ (props.ldapFMapLnameErrBor ? " selectErrorBorder" : "")}    >
                    {props.ldapEdit && props.fieldMapOpts.indexOf(props.fieldmap.lname)==-1 ?<option disabled={props.fieldmap.lname==="None"?true:false} value={props.fieldmap.lname} selected >{props.fieldmap.lname}</option>:null}
                    {props.fieldMapOpts.map((field,index)=>(
                        <option disabled={field==="None"?true:false} key={index} value={field} selected={field===props.fieldmap.lname}>{field}</option>
                    ))}
                </select>
            </div></div>
            <div className='adminControl-ldap-dm'><div>
                ...
                <select value={props.fieldmap.email} onChange={(event)=>{props.setFieldmap({uname: props.fieldmap.uname, fname: props.fieldmap.fname, lname: props.fieldmap.lname, email: event.target.value})}}  id="ldapFMapEmail" className={'adminSelect-ldap-dm form-control-ldap-dm'+ (props.ldapFMapEmailErrBor ? " selectErrorBorder" : "")}   >
                    {props.ldapEdit && props.fieldMapOpts.indexOf(props.fieldmap.email)==-1 ?<option disabled={props.fieldmap.email==="None"?true:false} value={props.fieldmap.email} selected >{props.fieldmap.email}</option>:null}
                    {props.fieldMapOpts.map((field,index)=>(
                        <option disabled={field==="None"?true:false} key={index} value={field} selected={field===props.fieldmap.email}>{field}</option>
                    ))}
                </select>
            </div></div>
