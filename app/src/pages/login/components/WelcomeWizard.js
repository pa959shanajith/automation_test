...
//         <button className="type1-button" onClick={()=>{updateStepNumber(1)}}>I Agree</button>
//     </div>
//   };

  const InstallationSteps_win = [
      {subtitle:"Open", content:<>Open the "AvoAssureClient.exe" file either from:
      <br/><ol type="a" style={{margin: 0, paddingLeft: 20}}><li>Download panel at the bottom of your browser window.</li><li>Browser's downloads section.</li><li>System's downloads folder.</li></ol></>, imageName:"instruction-1"},
      ...
      {subtitle:"Connect", content:<><ol type="a" style={{margin: 0, paddingLeft: 20}}><li>In extracted files, Click on <b>"run.bat."</b></li><li>For Register: enter the hostname and token into AvoAssure Client popup window, shared in the registration email.</li><li>Click on the <b>Connect</b> button in AvoAssure Client.</li></ol></>,imageName:"instruction-4"}
  ] 

  const InstallationSteps_mac = [
    {subtitle:"Open", content:<>Open and Extract the "AvoAssureClient.zip" file either from:
    <br/><ol type="a" style={{margin: 0, paddingLeft: 20}}><li>Download panel at the bottom of your browser window.</li><li>Browser's downloads section.</li><li>System's downloads folder.</li></ol></>, imageName:"instruction-1_mac"},
    {subtitle:"Install",content:<><div style={{fontStyle:"italic", marginBottom:5}}>Note - You need to have <b>Python v3.7.9</b> installed in your system or <a style={{color:"#5f338f"}} href="https://www.python.org/ftp/python/3.7.9/python-3.7.9-macosx10.9.pkg">click here to install</a>.</div><ol type="a" style={{margin: 0, paddingLeft: 20}}><li>Go to the extracted folder, click on more options icon, and select "New Terminal at Folder"</li><li>Type <b>"unquarantine.sh"</b> in the terminal window and press enter.</li><li>Type <b>"run.sh"</b> and press enter.</li></ol></>,imageName:"instruction-2_mac"},
    {subtitle:"Connect", content:<><ol type="a" style={{margin: 0, paddingLeft: 20}}><li>For Register: enter the hostname and token into AvoAssure Client popup window, shared in the registration email.</li><li>Click on the <b>Connect</b> button in AvoAssure Client.</li></ol></>,imageName:"instruction-3_mac"}
  ]
  ...
  return (
      <div className={"WW_container "+(activeStep>2?AnimationClassNames.fadeOut500:AnimationClassNames.fadeIn100)}>
        <div className="form">
        <div className="progressbar">
             <Stepper
                steps={[
                    { label: 'Download', active:activeStep===0, completed:activeStep>0, children:activeStep===0?1:<i className="fa fa-check"></i>},
                    { label: 'Setup', active:activeStep===1, completed:activeStep>1, children:(activeStep<=1)?2:<i className="fa fa-solid fa-check"></i>},
        ...
        <div className="form-container">
            ...
            {activeStep===0?getDownloadStep():null}
            {activeStep===1?afterDownloadInstructions():null}
        ...
        {<div className="WelcomeContactUs">For help, <a href="mailto:support@avoautomation.com">Click here</a> OR <a href="mailto:support@avoautomation.com">Contact us</a></div>}
        </div>
    </div>
  );
}
