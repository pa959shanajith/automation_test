            ...
            <Header />
                <div className="s__mid_section">
                    ...
                    <div className="s__content">
                        <ScheduleContent execEnv={execEnv} setBrowserTypeExe={setBrowserTypeExe} setExecAction={setExecAction} appType={appType} browserTypeExe={browserTypeExe} execAction={execAction} />
                    </div>
                    <ReferenceBar /> 
                </div>
