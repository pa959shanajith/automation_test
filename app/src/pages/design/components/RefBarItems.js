...
const ReferenceContent = ({mirror,collapse,appType,openScrapeScreen1}) => {
    ...
    <div className="ic_box" onClick={()=>openScrapeScreen1('displayBasic') }><img className={"rb__ic-task thumb__ic "} alt="screenshot-ic" title="Screenshot" src="static/imgs/ic-screenshot.png"/><span className="rb_box_title">Capture Elements</span></div>
    </ReferenceBar>
