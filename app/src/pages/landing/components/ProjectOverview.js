    ...
    return (
        <div className="surface-card OverviewSection">
            <div className='DefaultProject'>
                {defaultselectedProject && defaultselectedProject.appType === "5db0022cf87fdec084ae49b6" && (<img src="static/imgs/Web.svg" alt="Web App Icon" height="35" />)}
                {defaultselectedProject && defaultselectedProject.appType === "5db0022cf87fdec084ae49b2" && (<img src="static/imgs/MobileWeb.svg" alt="Mobile App Icon" height="35" />)}
                {defaultselectedProject && defaultselectedProject.appType === "5db0022cf87fdec084ae49af" && (<img src="static/imgs/Desktop.svg" alt="Mobile App Icon" height="35" />)}
                {defaultselectedProject && defaultselectedProject.appType === "5db0022cf87fdec084ae49b7" && (<img src="static/imgs/WebService.svg" alt="Mobile App Icon" height="35" />)}
                {defaultselectedProject && defaultselectedProject.appType === "5db0022cf87fdec084ae49b4" && (<img src="static/imgs/SAP.svg" alt="Mobile App Icon" height="35" />)}
