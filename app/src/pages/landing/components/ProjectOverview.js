    ...
    return (
        <div className="surface-card OverviewSection">
            <div className='DefaultProject'>
                ...
                {defaultselectedProject && defaultselectedProject.appType === "Mainframes" && (<img src="static/imgs/Mainframes.svg" alt="Mobile App Icon" height="35" width='30' />)}
                {defaultselectedProject && defaultselectedProject.appType === "MobileApps" && (<img src="static/imgs/MobileApps.svg" alt="Mobile App Icon" height="35" width='30' />)}
                {defaultselectedProject && defaultselectedProject.appType === "System_application" && (<img src="static/imgs/System_application.svg" alt="Mobile App Icon" height="20" />)}
